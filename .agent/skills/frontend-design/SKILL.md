...
description: Use when creating distinctive, production-grade frontend interfaces that avoid generic AI aesthetics. Guides bold aesthetic choices, typography, color, motion, and spatial composition for memorable web experiences.
---
...
**Core principle:** Bold maximalism and refined minimalism both work - the key is intentionality, not intensity. Execute the vision with precision.

## When to Use

- Creating new frontend components, pages, or applications
- Building interfaces that need to stand out visually
- User wants memorable, distinctive web experiences
- Avoiding generic, cookie-cutter designs
- Need for production-grade, functional code with strong aesthetics
...
| ❌ Avoid | ✅ Instead |
|----------|-----------|
| Arial | Distinctive display fonts |
| Inter | Characterful choices |
| Roboto | Unexpected pairings |
| System fonts | Refined body fonts |
| Generic sans-serif | Memorable type |

Pair a distinctive display font with a refined body font. Search Google Fonts for typefaces that elevate the aesthetic.
...
- Dark and light themes both valid - choose intentionally
- Never default to clichéd schemes (purple gradients on white backgrounds)
...
- Use scroll-triggering that surprises
...
|---------|--------------|
| Overused font families (Inter, Roboto, Arial) | Instantly signals generic AI output |
| Purple gradients on white backgrounds | Clichéd and forgettable |
| Predictable layouts | Cookie-cutter appearance |
| Component patterns without context | Lacks specific character |
| Same aesthetic every time | No differentiation |
...
| Vision Type | Implementation Approach |
|-------------|------------------------|
| Maximalist designs | Elaborate code with extensive animations and effects |
| Minimalist/refined designs | Restraint, precision, careful attention to spacing, typography, subtle details |
...
| Problem | Fix |
|---------|-----|
| Generic font choices | Search for distinctive, characterful typefaces |
| Safe color palette | Commit to dominant colors with sharp accents |
| No motion at all | Add high-impact animations at key moments |
| Standard layouts | Break the grid, use asymmetry and overlap |
| Solid color backgrounds | Add depth with gradients, textures, patterns |
| Same style every time | Vary aesthetics intentionally |

## Common Mistakes

| Mistake | Fix |
|---------|-----|
| Using Inter/Roboto/Arial | Choose unexpected, characterful fonts |
| Purple gradient defaults | Commit to context-specific color schemes |
| Scattered micro-interactions | Focus on one orchestrated page load moment |
| Timid color distribution | Use dominant colors with sharp accents |
| Playing it safe | Commit fully to a distinctive vision |
| Adding without intention | Every element should serve the aesthetic |

---

## Implementation Checklist

- [ ] Defined clear aesthetic direction before coding
- [ ] Typography is distinctive and memorable
- [ ] Color scheme is cohesive with CSS variables
- [ ] Motion is purposeful and high-impact
- [ ] Layout breaks expectations appropriately
- [ ] Backgrounds create atmosphere and depth
- [ ] No generic AI aesthetic markers
- [ ] Production-grade and functional
- [ ] Meticulously refined in every detail
...
**Pairs with:**
- `frontend-components` - Use for React component patterns
- `glassmorphism-design` - For glass-effect UI aesthetics
- `brainstorming` - Use when exploring design directions
